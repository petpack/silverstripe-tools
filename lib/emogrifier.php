<?php
/**
 * TIM: I've replaced this entire file with a more updated version as it
 * had a large amount of fixes in it, including improved support for CSS3
 * I've only tested this on a 'Viewing a Newsletter' link from the homepage thus far.
 *
 * @source: https://github.com/sunnysideup/silverstripe-newsletter_emogrify/blob/master/thirdparty/Emogrifier.php
 *
